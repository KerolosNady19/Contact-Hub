            ...
            <div class="contact-card-footer d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-1">
                    ...
                    <button class="btn-action-square red ${contactList[i].userEmergency ? 'active' : ''}" onclick="toggleEmergency(${i})">
                        <i class="fa-${contactList[i].userEmergency ? 'solid fa-heart-pulse' : 'regular fa-heart'}"></i>
                    </button>
...
function addContact() {
    if (validateName() && validatePhone() && validateEmail()) {
        ...
        // Missing Name Error from Screenshot
        Swal.fire({
            title: "Missing Name",
...
function deleteContact(index) {
    var userName = contactList[index].userName;
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            // Optional: Success toast after delete
            Swal.fire({
                title: "Deleted!",
...
function validateName() {
    var text = contactName.value;
    var regex = /^[a-zA-Z\s\u0600-\u06FF]{2,50}$/;
